...
//         }
//
//         browser = new webdriver.Builder().withCapabilities({browserName: browserName}).setChromeOptions(chromeOptions).build();
//
//         browser.get(baseUrl);
//
//         page = laxMode
//             ? new PageLaxMode(browser)
//             : new Page(browser);
...
//             return browser.executeScript('window.localStorage && localStorage.clear(); location.reload(true);').then(function() {
//                 done();
//             });
//         });
//     } else {
...
//             page.clickMarkAllCompletedCheckBox();
//
//             testOps.assertItemCompletedStates([false, false, false]).then(function() {
//                 done();
//             });
//         });
//
...
//             testOps.assertItems([TODO_ITEM_ONE, 'buy some sausages', TODO_ITEM_THREE]).then(function() {
//                 done();
//             });
//         });
//
...
//             testOps.assertItems([TODO_ITEM_ONE, TODO_ITEM_TWO, TODO_ITEM_THREE]).then(function() {
//                 done();
//             });
//         });
//
...
//             page.toggleItemAtIndex(1);
//             testOps.assertClearCompleteButtonText('Clear completed').then(function() {
//                 done();
//             });
//         });
//
...
//             testOps.assertItems([TODO_ITEM_ONE, page.ITEM_HIDDEN_OR_REMOVED, TODO_ITEM_THREE]).then(function() {
//                 return done();
//             });
//         });
//
